...
<head>
    ...
    <title inertia>{{ config('app.name', 'Garasi Belajar Banjarnegera') }}</title>
    ...
    <meta property="og:image" content="https://garasibelajar.com/og-image.png" />
    ...
    <meta name="twitter:image" content="https://garasibelajar.com/og-image.png" />
