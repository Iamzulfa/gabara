...
const defaultFaqs: QA[] = [
  {
    ...
    answer:
      "Gabara (Garasi Belajar Banjarnegara) adalah wadah belajar non-formal yang hadir untuk membantu anak-anak, remaja, maupun orang dewasa yang sempat putus sekolah agar tetap bisa melanjutkan pendidikan dan meraih masa depan lebih baik.",
  },
  {
    question: "Siapa saja yang bisa ikut belajar?",
    answer:
      "Semua masyarakat Banjarnegara yang putus sekolah, baik tingkat SD, SMP, maupun SMA, dapat bergabung di Gabara tanpa batasan usia tertentu.",
  },
  {
    question: "Apakah belajar di Gabara berbayar?",
    answer:
      "Tidak. Gabara merupakan inisiatif sosial yang memberikan fasilitas belajar secara gratis agar pendidikan bisa diakses oleh semua kalangan.",
  },
  {
...
- Kelas motivasi untuk membangun semangat belajar`,
  },
  {
    ...
    answer:
      "Tidak. Gabara terbuka untuk semua usia yang ingin melanjutkan pendidikan.",
  },
];
      ...
      <div className="container mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
        ...
        <div className="flex justify-center">
          <img
            ...
            className="w-full max-w-sm lg:max-w-md object-cover rounded-xl shadow-md"
          />
        </div>
